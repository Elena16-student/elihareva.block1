...
def print_params(a = 1, b = 'разберись', c = True):
    print(a, b, c)
    #print(a, b)
   # print ()
# print(3, 'разберись', 46)
# print("как",8)
# print()
print_params(b = 444)
print_params(c = 555)
print_params()
value_list = [12.35, 'замена']
print_params(*value_list)
print_params(*value_list, 84)
value_list_2 = ['sjo', 'njv']
print_params(*value_list_2)
print_params(1,25, [9, 3, 3])
value_dict = {'a':4, 'b':6, 'c':5}
