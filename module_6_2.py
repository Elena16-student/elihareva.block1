...
# в списке __COLOR_VARIANTS, в противном случае выводит на экран надпись: ("Нельзя сменить цвет "
#                                                                          "на <новый цвет>").
...
# from main import vehicle1

class Vehicle:
    __COLOR_VARIANTS = ['red', 'blue', 'pink', 'brown', 'silver']
    ...
    #         print(f'Цвета {new_color} нет в наличии, берите что дают')
...
vehicle1 = Sedan('Счастливый обладатель', 'Smart', 'silver', 600)
vehicle2 = Sedan('Курьер', 'Nissan', 'red', 700)
vehicle3 = Sedan('Водила', 'Golf', 'blue', 700)
...
vehicle1.set_color('BLACK')
vehicle3.set_color('Brown')
vehicle1.owner = 'Второй владелец'
vehicle2.owner = 'Таксист'
vehicle3.owner = 'Гонщик'
